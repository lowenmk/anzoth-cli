...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build a canonical Anzoth package directory and optional archive.",
...
def main() -> int:
    ...
    package_dir = (
        ...
        else Path(tempfile.mkdtemp(prefix="anzoth-package-")).resolve()
    )
    ...
    for archive_output in args.archive_output:
        ...
        print(f"Built Anzoth package archive at {archive_path}")

    print(f"Built Anzoth package directory at {package_dir}")
    return 0
