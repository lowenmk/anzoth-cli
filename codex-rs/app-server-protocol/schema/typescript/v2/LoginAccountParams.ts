...
export type LoginAccountParams = { "type": "apiKey", apiKey: string, } | { "type": "Anzoth.OAuth", codexStreamlinedLogin?: boolean, useHostedLoginSuccessPage?: boolean, appBrand?: LoginAppBrand | null, } | { "type": "chatgptDeviceCode" } | { "type": "chatgptAuthTokens",
/**
