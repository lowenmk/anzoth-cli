...
const ANNOUNCEMENT_TIP_URL: &str =
    "https://raw.githubusercontent.com/anzoth/cli/main/announcement_tip.toml";

const IS_MACOS: bool = cfg!(target_os = "macos");
const IS_WINDOWS: bool = cfg!(target_os = "windows");

const APP_TOOLTIP: &str =
    "Try the **Anzoth desktop app**. Run 'anzoth app' for the desktop experience.";
const FAST_TOOLTIP: &str =
    "*New* Use **/fast** to enable our fastest inference with increased plan usage.";
const OTHER_TOOLTIP: &str = "*New* Build faster with the **Anzoth desktop app**. Run 'anzoth app' for the desktop experience.";
const OTHER_TOOLTIP_NON_MAC: &str = "*New* Build faster with Anzoth.";
const FREE_GO_TOOLTIP: &str =
    "*New* Get started with Anzoth and keep your work local, fast, and focused.";
...
/// Pick a random tooltip to show to the user when starting Anzoth.
    ...
    impl TargetOs {
        const fn current() -> Self {
            if cfg!(target_os = "macos") {
                ...
                // Anzoth currently publishes CLI builds for macOS, Windows, and Linux.
                Self::Linux
            }
        }
    }
...
from_date = "2000-01-01"
    ...
    fn announcement_tip_toml_parse_comments() {
        let toml = r#"
# Example announcement tips for Anzoth TUI.
...
[[announcements]]
content = "Welcome to Anzoth! Check out the new onboarding flow."
